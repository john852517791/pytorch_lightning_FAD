...
def f_args_parsed(argument_input = None):
    ...
    parser.add_argument('--no_best_epochs', type=int, default=3)
    ...
    parser.add_argument('--loss_weight', type=float, default=0.0)
    parser.add_argument('--moe_topk', type=int, default=2)
    parser.add_argument('--moe_experts', type=int, default=4)
    parser.add_argument('--moe_exp_hid', type=int, default=128)
