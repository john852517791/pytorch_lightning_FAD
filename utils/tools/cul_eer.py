...
def get_alltrn_data_kv():
    ...
    # 打开txt文件进行读取
    with open('/data8/wangzhiyong/project/fakeAudioDetection/lightning_FAD/datasets/asvspoof2019/LA/ASVspoof2019_LA_cm_protocols/ASVspoof2019.LA.cm.train.trn.txt', 'r') as file:
        # 逐行读取文件内容
        for line in file:
...
if __name__ == "__main__":
    ...
    # asvspoof 2019
    labelFile="/data2/public_datasets/asvspoof2019/LA/ASVspoof2019_LA_cm_protocols/ASVspoof2019.LA.cm.eval.trl.txt"
    asvlabel="/data2/public_datasets/asvspoof2019/LA/ASVspoof2019_LA_asv_scores/ASVspoof2019.LA.asv.eval.gi.trl.scores.txt"
