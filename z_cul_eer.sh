...
echo $line
eval $line
line="python utils/tools/cul_eer21.py --scoreFile $scoreFilepath/infer_LA21.log --phase hidden > $scoreFilepath/eer_21_hid"
echo $line
eval $line
line="python utils/tools/cul_eer21df.py --scoreFile $scoreFilepath/infer_DF21.log > $scoreFilepath/eer_df21"
echo $line
eval $line
line="python utils/tools/cul_eer21df.py --scoreFile $scoreFilepath/infer_DF21.log --phase hidden_track > $scoreFilepath/eer_df21_hid"
echo $line
eval $line
